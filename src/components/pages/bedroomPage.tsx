...
const BedroomPage = React.forwardRef<HTMLDivElement, BedroomPageProps>(({ shouldAnimate }, ref) => {
  ...
  return (
    <div ref={ref} className="w-full h-[500vh] relative bg-white">
      ...
      <div className="min-w-[85%] min-h-screen m-16 relative bg-bedroom1 bg-contain bg-right-top bg-no-repeat" />
      <div className="min-w-[85%] min-h-screen  m-16 relative bg-bedroom2 bg-contain bg-right-top bg-no-repeat" />
      <div className="min-w-[85%] min-h-screen  m-16 relative bg-bedroom3 bg-contain bg-right-top bg-no-repeat" />
    </div>
  );
});
